      ...
      <div class="content">
        <div class="card has-background-light">
              ...
              <article class="media">
                ...
                <div v-else class="media-content">
                  ...
                  <nav class="level">
                    ...
                    <div v-if="user && (comment.comment_by_id == user.id || user.role == 'admin')" class="level-right">
                      <div class="level-item">
          ...
          <footer class="card-footer">
            ...
            <a v-if="user && (user.id == blog.create_by_id || user.role == 'admin')" class="card-footer-item"
              @click="deleteBlog">
